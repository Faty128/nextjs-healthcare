            ...
            <div className="p-4 bg-white rounded-lg shadow-md">
              ...
              <div className="mt-4 pt-4">
                <div className="flex justify-between items-center mb-4 font-bold">
                  ...
                  <span className="text-sm underline text-teal-500">
                    View All
                  </span>
                </div>
                <div className="flex justify-start items-center gap-4 rounded-lg bg-[#F0F9FD] p-2">
                  <div
                    className="w-[50px] h-[50px] p-3 text-center text-white rounded-full shadow-md"
                    style={{
                      background:
                        "linear-gradient(66.15deg, #57B4DE -5.25%, #58B6DD 35.43%, #3B29AB 98.77%)",
                    }}
                  >
                    M
                  </div>
                  ...
                  <div className=" h-[350px] pt-14 space-y-1 gap-0">
                    <div className="flex justify-around items-center">
                      <div className="flex gap-8">
                        ...
                        <div className="p-3 font-bold">
                          ...
                          <p className="text-[#F6208899] text-sm">
                            Weekly Visit
                          </p>
                        </div>
                      </div>
                      <div className="w-[60px] h-[30px] rounded-md bg-[#f8aed299] border-gray-700">
                        <span className="text-xs text-[#F6208899] p-2">
                          9:15AM
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-around items-center ">
                      <div className="flex gap-8">
                        ...
                        <div className="p-3 font-bold">
                          ...
                          <p className="text-[#0000FF99] text-sm">
                            Routine Checkup
                          </p>
                        </div>
                      </div>
                      <div className="w-[60px] h-[30px] rounded-md bg-[#b9b9f799] border-gray-700">
                        <span className="text-xs text-[#0000FF99] p-2">
                          9:30AM
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-around items-center ">
                      ...
                      <div className="w-[60px] h-[30px] rounded-md bg-[#c4eeec99] border-gray-700 py-2">
                        <span className="text-xs text-[#12898399] p-2">
                          9:50AM
                        </span>
                      </div>
                    </div>
                ...
                <div className="w-full md:w-4/8 relative">
                    ...
                    <div className="flex justify-around items-center pb-4">
                      <div className="flex justify-start items-center gap-5 m-0 ">
                        ...
                        <div className="w-[26px] h-[26px] rounded-full bg-gray-300 border-gray-700 relative">
                          <span className="p-1 text-gray-600  text-2xl absolute -top-4 left-0">
                            ...
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="absolute bottom-6 text-xs justify-center items-start m-3  space-y-4">
                    ...
                    <div className="flex justify-start items-start gap-3">
                      ...
                      <p>
                        Paracetmol-2times a day Dizopam-Day and Night before
                        meal wikoryl
                      </p>
                    </div>
                  </div>
